        ...
        <div className="mx-auto max-w-7xl px-6 py-24 md:px-12 md:py-32">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] p-8 transition-all hover:border-white/10 hover:bg-white/[0.04]">
              ...
              <h3 className="mb-2 text-lg font-semibold text-white">Go'on</h3>
              <p className="text-sm leading-relaxed text-white/40">
               Sweden top Golf Club.
              </p>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] p-8 transition-all hover:border-white/10 hover:bg-white/[0.04]">
              ...
              <h3 className="mb-2 text-lg font-semibold text-white">Wedge</h3>
              <p className="text-sm leading-relaxed text-white/40">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] p-8 transition-all hover:border-white/10 hover:bg-white/[0.04]">
              ...
              <h3 className="mb-2 text-lg font-semibold text-white">A Battery Of Example</h3>
              <p className="text-sm leading-relaxed text-white/40">
              ...
              <div className="mt-6 flex items-baseline gap-2">
                ...
                <span className="text-sm text-white/40">x</span>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] p-8 transition-all hover:border-white/10 hover:bg-white/[0.04]">
              ...
              <h3 className="mb-2 text-lg font-semibold text-white">XXX</h3>
              <p className="text-sm leading-relaxed text-white/40">
                XXX.
              </p>
              <div className="mt-6 flex items-baseline gap-2">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] p-8 transition-all hover:border-white/10 hover:bg-white/[0.04]">
              ...
              <h3 className="mb-2 text-lg font-semibold text-white">x</h3>
              <p className="text-sm leading-relaxed text-white/40">
                x.
              </p>
              <div className="mt-6 flex items-baseline gap-2">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/5 bg-white/[0.02] p-8 transition-all hover:border-white/10 hover:bg-white/[0.04]">
              ...
              <p className="text-sm leading-relaxed text-white/40">
                Designed for all-day comfort without compromising
                .
              </p>
              <div className="mt-6 flex items-baseline gap-2">
                <span className="text-2xl font-semibold text-white">x</span>
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 md:px-12 md:py-32">
          <div className="grid gap-12 md:grid-cols-2 md:gap-16">
            ...
            <div className="flex flex-col justify-center">
              <p className="text-sm text-white/40">Wherings J LIndberg  </p>
